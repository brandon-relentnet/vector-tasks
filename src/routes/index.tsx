...
function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-65px)] overflow-hidden text-foreground">
      ...
      <div className="relative bg-transparent shadow-2xl border-zinc-800 border-b">
      ...
      <div className="flex flex-1 bg-background/50 overflow-hidden">
        ...
        <div className="hidden md:flex flex-col bg-background/60 shadow-[1px_0_10px_rgba(0,0,0,0.02)] border-border border-r w-64">
          ...
          {!isTimerActive && (
            <div className="space-y-4 bg-zinc-900 dark:bg-zinc-950 shadow-xl mx-4 mb-4 p-4 border border-zinc-800 rounded-2xl">
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center bg-zinc-800 p-1.5 border border-zinc-700/50 rounded-xl">
                <button
              ...
              <Button
                className="bg-primary shadow-lg rounded-xl w-full h-9 font-black text-[10px] text-black uppercase"
          ...
          {isTimerActive && (
            <div className="group flex justify-between items-center bg-primary shadow-[0_0_20px_rgba(255,190,0,0.2)] mx-4 mb-4 p-4 rounded-2xl">
              <div className="flex items-center gap-3">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="hover:bg-black/10 p-0 w-8 h-8 text-black"
                onClick={() => handleTimerAction(null)}
              >
