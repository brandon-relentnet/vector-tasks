    ...
    <div className="h-[calc(100vh-65px)] flex flex-col overflow-hidden text-foreground">
      ...
      <div className="flex-1 flex overflow-hidden bg-background">
        ...
        <div className="w-64 border-r border-border bg-card flex flex-col shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          ...
          <div className={`mx-4 mb-4 rounded-2xl shadow-xl transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] border overflow-hidden ${
            isTimerActive 
              ? 'bg-primary border-primary p-4' 
              : 'bg-zinc-900 dark:bg-zinc-950 border-zinc-800 p-4'
          }`}>
            {!isTimerActive ? (
              ...
              <div className="flex items-center justify-between group animate-in fade-in zoom-in-95 duration-500 fill-mode-forwards">
                <div className="flex items-center gap-3">
                ...
                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-black hover:bg-black/10 transition-colors" onClick={() => handleTimerAction(null)}>
